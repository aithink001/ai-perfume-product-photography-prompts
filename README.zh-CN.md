...
> TDH: 香水商品图 AI 提示词 | 护肤品商品图 Prompt | 美妆电商图 AI 模板

这个仓库是一个垂直的 AI 商品图提示词资源库，专门整理香水瓶、护肤品、精华、喷雾和美妆电商图的可复制 prompt。适合淘宝、天猫、小红书、Shopify、Amazon、独立站和 Seedance 商品视频。
...
```text
香水商品图 AI 提示词：18 个护肤品、美妆电商图和香水瓶产品摄影 Prompt
```

Description:

```text
整理 18 个香水和护肤品商品图 AI 提示词，覆盖白底主图、透明玻璃瓶、高级棚拍、花香成分图、小红书封面、独立站 Hero 和 Seedance ASMR 视频。
```
...
- [中文提示词正文](prompts/zh/perfume-product-photography.md)
